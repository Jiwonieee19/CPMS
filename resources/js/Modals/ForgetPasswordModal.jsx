            ...
            >
                ...
                <div className="mb-8 text-center">
                    <p className="text-[#F5F5DC] text-lg mb-2">
                        Please seek guidance from the account manager directly.
                    </p>
                    {/* <p className="text-[#F5F5DC] text-sm mt-4">
                        For security reasons, password resets must be handled by the account manager.
                    </p> */}
                </div>
                ...
                <div className="mt-8">
                    <button
                        onClick={handleClose}
                        className="w-full py-3 rounded-2xl bg-[#311F1C] text-[#E5B917] text-xl font-semibold hover:bg-[#E5B917] hover:text-[#311F1C] transition"
                    >
                        CLOSE
                    </button>
                </div>
